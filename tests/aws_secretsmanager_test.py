...
# Aliased to keep the per-call type-ignore comments within the line limit.
asm_backend = asm_plugin_mod.aws_secretsmanager_backend
...
def test_explicit_keys_are_passed_through(mocker: MockerFixture) -> None:
    ...
    secret = asm_backend(  # type: ignore[no-untyped-call]
